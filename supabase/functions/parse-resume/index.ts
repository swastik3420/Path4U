...
const SKILL_DICTIONARY: Record<string, { name: string; category: string }> = {
  ...
  "cad": { name: "CAD", category: "Mechanical Engineering" },
  "cam": { name: "CAM", category: "Mechanical Engineering" },
  "cae": { name: "CAE", category: "Mechanical Engineering" },
  ...
  "fea": { name: "Finite Element Analysis (FEA)", category: "Mechanical Engineering" },
  "computational fluid dynamics": { name: "Computational Fluid Dynamics (CFD)", category: "Mechanical Engineering" },
  "cfd": { name: "Computational Fluid Dynamics (CFD)", category: "Mechanical Engineering" },
  ...
  "rcc": { name: "RCC Design", category: "Civil Engineering" },
  ...
  "surveying": { name: "Site Surveying", category: "Civil Engineering" },
  "quantity estimation": { name: "Quantity Estimation", category: "Civil Engineering" },
  "bar bending schedule": { name: "Bar Bending Schedule (BBS)", category: "Civil Engineering" },
  "bbs": { name: "Bar Bending Schedule (BBS)", category: "Civil Engineering" },
  "gis": { name: "GIS", category: "Civil Engineering" },
  ...
  "plc": { name: "PLC", category: "Electrical Engineering" },
  ...
  "dsp": { name: "Digital Signal Processing (DSP)", category: "Electronics & Communication" },
  ...
  "pcb": { name: "PCB Layout", category: "Electronics & Communication" },

  // ===== Data Science / AI / ML / LLM =====
  "hugging face": { name: "Hugging Face Transformers", category: "AI/ML" },
  "transformers": { name: "Hugging Face Transformers", category: "AI/ML" },
  "langchain": { name: "LangChain", category: "AI/ML" },
  "llamaindex": { name: "LlamaIndex", category: "AI/ML" },
  "scipy": { name: "SciPy", category: "AI/ML" },
  "jupyter": { name: "Jupyter", category: "AI/ML" },
  "mlflow": { name: "MLflow", category: "AI/ML" },
  "weights & biases": { name: "Weights & Biases", category: "AI/ML" },
  "wandb": { name: "Weights & Biases", category: "AI/ML" },
  "cnn": { name: "Convolutional Neural Networks (CNN)", category: "AI/ML" },
  "convolutional neural network": { name: "Convolutional Neural Networks (CNN)", category: "AI/ML" },
  "rnn": { name: "Recurrent Neural Networks (RNN)", category: "AI/ML" },
  "recurrent neural network": { name: "Recurrent Neural Networks (RNN)", category: "AI/ML" },
  "transformer architecture": { name: "Transformer Architecture", category: "AI/ML" },
  "attention mechanism": { name: "Attention Mechanisms", category: "AI/ML" },
  "feature engineering": { name: "Feature Engineering", category: "AI/ML" },
  "model optimization": { name: "Model Optimization", category: "AI/ML" },
  "fine-tuning": { name: "Fine-Tuning", category: "AI/ML" },
  "fine tuning": { name: "Fine-Tuning", category: "AI/ML" },
  "rag": { name: "Retrieval-Augmented Generation (RAG)", category: "AI/ML" },
  "retrieval-augmented generation": { name: "Retrieval-Augmented Generation (RAG)", category: "AI/ML" },
  "prompt engineering": { name: "Prompt Engineering", category: "AI/ML" },
  "llm": { name: "Large Language Models (LLM)", category: "AI/ML" },

  // ===== Data Engineering =====
  "databricks": { name: "Databricks", category: "Data Engineering" },
  "snowflake": { name: "Snowflake", category: "Data Engineering" },
  "dbt": { name: "dbt", category: "Data Engineering" },
  ...
  "query optimization": { name: "Query Optimization", category: "Data Engineering" },
  "distributed computing": { name: "Distributed Computing", category: "Data Engineering" },
  "elt": { name: "ELT", category: "Data Engineering" },

  // ===== Data Analytics =====
  "looker": { name: "Looker", category: "Data Analytics" },
  "qlik": { name: "Qlik Sense", category: "Data Analytics" },
  "vba": { name: "Excel VBA", category: "Data Analytics" },
  "dax": { name: "DAX", category: "Data Analytics" },
  "power query": { name: "Power Query", category: "Data Analytics" },
  "eda": { name: "Exploratory Data Analysis (EDA)", category: "Data Analytics" },
  "exploratory data analysis": { name: "Exploratory Data Analysis (EDA)", category: "Data Analytics" },
  ...
  "kpi": { name: "KPI Tracking", category: "Data Analytics" },
  "statistical analysis": { name: "Statistical Analysis", category: "Data Analytics" },
  "predictive modeling": { name: "Predictive Modeling", category: "Data Analytics" },
  ...
  "sentinel": { name: "Microsoft Sentinel", category: "Cybersecurity" },
  ...
  "siem": { name: "SIEM", category: "Cybersecurity" },
  "iam": { name: "Identity & Access Management (IAM)", category: "Cybersecurity" },
  "soc": { name: "SOC Operations", category: "Cybersecurity" },
  ...
  "ble": { name: "Bluetooth Low Energy (BLE)", category: "IoT" },
  "bluetooth low energy": { name: "Bluetooth Low Energy (BLE)", category: "IoT" },
  "modbus": { name: "Modbus", category: "IoT" },
  "embedded systems": { name: "Embedded Systems", category: "IoT" },
  "sensor integration": { name: "Sensor Integration", category: "IoT" },
  "edge computing": { name: "Edge Computing", category: "IoT" },
  "firmware": { name: "Firmware Development", category: "IoT" },
  "rtos": { name: "RTOS", category: "IoT" },
  ...
  "remix": { name: "Remix IDE", category: "Blockchain" },
  ...
  "smart contract": { name: "Smart Contracts", category: "Blockchain" },
  "dapp": { name: "Decentralized Applications (dApps)", category: "Blockchain" },
  "erc-20": { name: "ERC-20", category: "Blockchain" },
  "erc-721": { name: "ERC-721", category: "Blockchain" },
  "consensus": { name: "Consensus Mechanisms", category: "Blockchain" },
  "defi": { name: "DeFi", category: "Blockchain" },
  "zero-knowledge": { name: "Zero-Knowledge Proofs (ZKP)", category: "Blockchain" },
  "zkp": { name: "Zero-Knowledge Proofs (ZKP)", category: "Blockchain" },

  // ===== Biotechnology =====
  "pcr": { name: "Polymerase Chain Reaction (PCR)", category: "Biotechnology" },
  "polymerase chain reaction": { name: "Polymerase Chain Reaction (PCR)", category: "Biotechnology" },
  "hplc": { name: "HPLC", category: "Biotechnology" },
  ...
  "chimera": { name: "Chimera", category: "Biotechnology" },
  ...
  "premiere pro": { name: "Adobe Premiere Pro", category: "Media & Communication" },
  "final cut pro": { name: "Final Cut Pro", category: "Media & Communication" },
  "davinci resolve": { name: "DaVinci Resolve", category: "Media & Communication" },
  "audacity": { name: "Adobe Audacity", category: "Media & Communication" },
  "lightroom": { name: "Lightroom", category: "Media & Communication" },
  "investigative journalism": { name: "Investigative Journalism", category: "Media & Communication" },
  "copywriting": { name: "News Copywriting", category: "Media & Communication" },
  "video editing": { name: "Video Editing", category: "Media & Communication" },
  "media planning": { name: "Media Planning", category: "Media & Communication" },
  "broadcast": { name: "Broadcast Operations", category: "Media & Communication" },
  "scriptwriting": { name: "Scriptwriting", category: "Media & Communication" },
  "public relations": { name: "Public Relations (PR)", category: "Media & Communication" },
  "content strategy": { name: "Content Strategy", category: "Media & Communication" },
  "digital marketing": { name: "Digital Marketing", category: "Media & Communication" },
};
...
function extractJobTitles(text: string): string[] {
  ...
  const patterns = [
    /\b(Software Engineer|Software Developer|Full[- ]Stack Developer|Frontend Developer|Front[- ]End Developer|Backend Developer|Back[- ]End Developer|Web Developer|Mobile Developer|iOS Developer|Android Developer|Data Scientist|Data Analyst|Data Engineer|Analytics Engineer|Machine Learning Engineer|ML Engineer|AI Engineer|MLOps Engineer|LLM Engineer|Prompt Engineer|DevOps Engineer|Site Reliability Engineer|SRE|Cloud Engineer|Security Engineer|Cybersecurity Analyst|Penetration Tester|SOC Analyst|QA Engineer|Test Engineer|Product Manager|Project Manager|Program Manager|Engineering Manager|Technical Lead|Tech Lead|Team Lead|Solutions Architect|Software Architect|Systems Analyst|Business Analyst|UX Designer|UI Designer|Product Designer|Graphic Designer|Intern|Consultant|Research Scientist|Research Engineer|Database Administrator|DBA|Network Engineer|Systems Engineer|Mechanical Engineer|Design Engineer|CAD Engineer|Manufacturing Engineer|Production Engineer|HVAC Engineer|Automotive Engineer|Aerospace Engineer|Civil Engineer|Structural Engineer|Site Engineer|Construction Engineer|Geotechnical Engineer|Surveyor|Electrical Engineer|Power Engineer|Control Engineer|Automation Engineer|PLC Engineer|Electronics Engineer|Embedded Engineer|Embedded Systems Engineer|Firmware Engineer|VLSI Engineer|RF Engineer|Hardware Engineer|PCB Designer|IoT Engineer|Blockchain Developer|Smart Contract Developer|Solidity Developer|Web3 Developer|Biotechnologist|Bioinformatics Analyst|Research Associate|Lab Technician|Journalist|Reporter|Editor|Video Editor|Content Creator|Content Writer|PR Specialist|Media Planner|Broadcast Engineer)\b/gi,
  ];
